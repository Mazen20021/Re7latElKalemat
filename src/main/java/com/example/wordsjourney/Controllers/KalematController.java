...
public class KalematController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<GeneralResponse<userDTO>> SignUp(@RequestHeader(value = "name") String name,@RequestHeader(value = "email") String email, @RequestHeader(value = "password") String password,@RequestHeader(value = "picture") String picture) {
    ...
    @GetMapping("/login")
    public ResponseEntity<GeneralResponse<userDTO>> Login(@RequestHeader(value = "email") String email, @RequestHeader(value = "password") String password) {
